...
function _get_Θ(::Isotropic,A₀,B₀,a,b,c,d,Q,𝑘ₛ,Xᶜ,Yᶜ,Φ,Θ₁D,number_of_term)
    return (x,y,z) -> _Θ(Isotropic(),x,y,z,A₀,B₀,a,b,c,d,Q,𝑘ₛ,Xᶜ,Yᶜ,Φ,Θ₁D,number_of_term)
end
...
function solve(::Isotropic,a,b,c,d,Q,𝑘ₛ,δₛ,hᶜ,Xᶜ,Yᶜ,number_of_term)
    ...
    Θ = _get_Θ(Isotropic(),A₀,B₀,a,b,c,d,Q,𝑘ₛ,Xᶜ,Yᶜ,Φ,Θ₁D,number_of_term)
