...
function _Θ(::Compound, x, y, z,A₀,B₀,a,b,c,d,Q,𝑘ₛ,Xᶜ,Yᶜ,Φ,Θ₁D,number_of_term)
...
function _get_Θ(::Compound, A₀,B₀,a,b,c,d,Q,𝑘ₛ,Xᶜ,Yᶜ,Φ,Θ₁D,number_of_term)
    return (x, y, z) -> _Θ(Compound(), x, y, z, A₀,B₀,a,b,c,d,Q,𝑘ₛ,Xᶜ,Yᶜ,Φ,Θ₁D,number_of_term)
end
...
function solve(::Compound, a, b, c, d, Q, 𝑘ₛ, δₛ, 𝑘ₚ, δₚ, hᶜ, Xᶜ, Yᶜ, number_of_term)
    ...
    Θ = _get_Θ(Compound(), A₀,B₀,a,b,c,d,Q,𝑘ₛ,Xᶜ,Yᶜ,Φ,Θ₁D,number_of_term)  # Check Temperature distribution function
